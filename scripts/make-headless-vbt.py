#!/usr/bin/env python3
# Regenerates configs/macos/headless-vbt.bin, which `imac-patcher --apply macos`
# installs. The committed copy is this script's output; run it only to rebuild.
#
...
#
# Usage: ./make-headless-vbt.py [out-file]   (default: configs/macos/headless-vbt.bin)
